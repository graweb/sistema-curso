<div class="easyui-panel" style="padding:10px;">
    <form id="forBloqueioDeAulas" class="easyui-form" method="post" data-options="novalidate:true">
        <div>
...
function gerarRelatorioPacotesPorAluno(){
    ...
    $('#forBloqueioDeAulas').form('submit',{
        url: '',
        onSubmit: function(){
            return $(this).form('validate');
        },
        success: function(result){
            $('#conteudoRelatorios').panel('refresh', '<?php base_url();?>relatorios/bloqueio_de_aulas/' + $("#professor").val() + '/' + de + '/' + ate);
        }
    });
}
</script>