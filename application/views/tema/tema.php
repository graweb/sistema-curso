...
<meta name="description" content="GraWeb Tecnologia - EasyEnglish">
<meta name="keywords" content="GraWeb Tecnologia - EasyEnglish">
        ...
        if($("#senha_definir").val() == "")
        {
            ...
            if($("#senha_definir").val() == $("#senha_definir_confirma").val())
            {
                $('#formDefinirSenhaUsuario').form('submit',{
                    url: '<?php base_url();?>usuarios/definir_senha/'+<?php echo $this->session->userdata('idusuario');?>,
                    onSubmit: function(){
